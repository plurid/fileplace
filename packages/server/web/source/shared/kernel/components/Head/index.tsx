...
const Head: React.FC<HeadProperties> = (
    ...
    const titleValue = title || `fileplace`;
    const descriptionValue = description || 'centralized cloud file store viewer';
    const ogTitleValue = ogTitle || title || `fileplace`;
    const ogDescriptionValue = ogDescription || description || 'centralized cloud file store viewer';
